...
model_base = Claude(id="claude-sonnet-4-20250514")
...
ai_innovation_officer = Agent(
    ...
    skills=[
        ...
        {"type": "anthropic", "skill_id": "xlsx", "version": "latest"},
        {"type": "anthropic", "skill_id": "docx", "version": "latest"},
        {"type": "custom", "skill_id": ai_skill.id, "version": "latest"},
...
business_case_agent = Agent(
    ...
    model=Claude(
    id="claude-sonnet-4-20250514",skills=[
        {"type": "anthropic", "skill_id": "pptx", "version": "latest"},
        {"type": "anthropic", "skill_id": "xlsx", "version": "latest"},
        {"type": "custom", "skill_id":financial_metrics_skill.id, "version": "latest"},
...
budget_planning_agent = Agent(
    ...
    id="claude-sonnet-4-20250514",skills=[
        {"type": "anthropic", "skill_id": "pptx", "version": "latest"},
        {"type": "anthropic", "skill_id": "xlsx", "version": "latest"},
        {"type": "custom", "skill_id": mpesa_skill.id, "version": "latest"},
        {"type": "custom", "skill_id": financial_metrics_skill.id, "version": "latest"},
        {"type": "custom", "skill_id": safaricom_telco_skill.id, "version": "latest"},
